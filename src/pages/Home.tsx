      ...
      <div className="text-center space-y-12 max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
          <button
            ...
            className="w-80 h-24 bg-contain bg-center bg-no-repeat overflow-hidden transition-all duration-300 hover:bg-[length:105%_105%] hover:filter hover:invert hover:shadow-lg"
