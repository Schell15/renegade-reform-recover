  ...
  return (
    <div className="min-h-screen bg-cream font-grotesk">
      <SEO
        ...
        description="Reformer Pilates classes at Renegade Reformer in Redfield, Bristol. Strength-led, music-driven sessions for every level. Book your first class."
        path="/reformer"
      />
      {/* Header */}
